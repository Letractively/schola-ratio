...
public class InstituicaoDaoImpl extends DaoConfiguration<Instituicao> {
     ...
     */
    @Override
    public Integer salvar(Instituicao t) throws DaoException {
     ...
     */
    @Override
    public void excluir(Instituicao t) throws DaoException {
        super.excluir(t);
    }
    ...
    @Override
    public List<Instituicao> listar(Class clazz) throws DaoException {
     ...
     */
    @Override
    public List<Instituicao> pesquisar(Instituicao t) throws DaoException {
    ...
    @SuppressWarnings("rawtypes")
    @Override
    public Instituicao obterPorID(Class clazz, Integer id) throws DaoException {
