...
@Repository("mensalidadeDao")
public class MensalidadeDaoImpl extends DaoConfiguration<Mensalidade> {
     ...
     */
    @Override
    public Integer salvar(Mensalidade t) throws DaoException {
     ...
     */
    @Override
    public void atualizar(Mensalidade t) throws DaoException {
        super.atualizar(t);
    }
     ...
     */
    @Override
    public void excluir(Mensalidade t) throws DaoException {
        super.excluir(t);
    }
    ...
    @Override
    public List<Mensalidade> listar(Class clazz) throws DaoException {
     ...
     */
    @Override
    public List<Mensalidade> pesquisar(Mensalidade t) throws DaoException {
    ...
    @SuppressWarnings("rawtypes")
    @Override
    public Mensalidade obterPorID(Class clazz, Integer id) throws DaoException {
