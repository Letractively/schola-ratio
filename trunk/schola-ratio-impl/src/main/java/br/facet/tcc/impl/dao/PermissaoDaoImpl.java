...
public class PermissaoDaoImpl extends DaoConfiguration<Permissao> {
     ...
     */
    @Override
    public Integer salvar(Permissao t) throws DaoException {
     ...
     */
    @Override
    public void atualizar(Permissao t) throws DaoException {
        super.atualizar(t);
    }
     ...
     */
    @Override
    public void excluir(Permissao t) throws DaoException {
        super.excluir(t);
    }
    ...
    @Override
    public List<Permissao> listar(Class clazz) throws DaoException {
     ...
     */
    @Override
    public List<Permissao> pesquisar(Permissao t) throws DaoException {
        return super.pesquisar(t);
    }

    
     /**
     * @see br.facet.tcc.impl.dao.DaoConfiguration#obterPorID(java.lang.Class, java.lang.Integer)
     * @since since optional
     */
    @SuppressWarnings("rawtypes")
    @Override
    public Permissao obterPorID(Class clazz, Integer id) throws DaoException {
